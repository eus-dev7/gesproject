...
<div id="wrap">
  ...
  <footer class="container-fluid text-center" style="margin-top:0px;">
    ...
    <p><a href=""></a> <img src="img/PR.jpg" style="width:800px; height:400px; margin-top:65px;" /></p>
...
<div id="contenedor">
       <!-- <div id="titulo1" class="letras">
        ...
        <div id="titulo3" class="letras" style="margin-top:-65px;">
            <a href="inicio.php"><h1> INICIAR</h1></a>
        </div>  
    </div>
